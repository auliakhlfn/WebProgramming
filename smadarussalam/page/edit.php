    ...
    <div class="card-body">
        ...
        <form method="POST" action="<?= BASE_URL . 'process/process_edit.php' ?>">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="ktpsiswa" class="form-control" id="ktpsiswa" value="<?= $pegawai['ktpsiswa'] ?>">
            </div>
            <div class="mb-3">
                <label for="nimsiswa" class="form-label">NIM Siswa</label>
                <input type="number" name="nimsiswa" class="form-control" id="nimsiswa" value="<?= $pegawai['nimsiswa'] ?>">
            </div>
            <div class=" mb-3">
